""""
This file contains the test cases for the functions in the black_jack.py file.
The test cases are designed to test the following functions:
    - value_of_card
    - higher_card
    - value_of_ace
    - is_blackjack
...
class BlackJackTest(unittest.TestCase):
    """
    The test cases in this file are designed to test the functions in the black_jack.py file.
    The test cases are designed to test the following functions:
        - value_of_card
        - higher_card
        - value_of_ace
    ...
    def test_value_of_card(self):
        """ Test the value_of_card function. """
        ...
        for variant, (card_one, card_two, expected) in enumerate(test_data, 1):
            with self.subTest(
                ...
                error_msg = (f'Called higher_card({card_one}, {card_two}). '
                             ...
                             f'but the test expected {expected} ',
                             f'as the result for the cards {card_one, card_two}.')

                self.assertEqual(actual_result, expected, msg=error_msg)

    @pytest.mark.task(taskno=3)
    def test_value_of_ace(self):
        """ Test the value_of_ace function. """
    ...
    def test_is_blackjack(self):
        """ Test the is_blackjack function. """
    ...
    def test_can_split_pairs(self):
        """ Test the can_split_pairs function. """
